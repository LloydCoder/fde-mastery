...
def test_all_six_domains_have_deployment_safe_smoke_paths(monkeypatch):
    # No external LLM/network calls are permitted in the deployment smoke test.
    ...
    cases = [
        ...
        (
            ...
            Domain.FINANCE,
            {
                ...
                "counterparty_id": "counterparty-test",
        ...
        (
            ...
            Domain.HEALTHTECH,
            {
                ...
                "raw_notes": "Synthetic deployment smoke test.",
                "phi_redacted": True,
            },
        ),
        (
        ...
        (
            ...
            Domain.LEGAL,
            {
                "contract_id": "CONTRACT-DEPLOY-001",
        ...
        (
            ...
            Domain.REVOPS,
            {
                ...
                "telemetry": {
                    ...
                    "weekly_usage_growth_pct": 10,
                    "license_utilization_pct": 80,
                },
            },
        ),
    ]
