...
The layer deliberately stays provider-agnostic: adapters remain responsible
for provider-specific behavior while the platform controls execution time,
transient retries, concurrency, and circuit state.
"""
...
class ResilienceExecutor:
    """Execute an agent call with timeout, bounded retry and circuit control."""
