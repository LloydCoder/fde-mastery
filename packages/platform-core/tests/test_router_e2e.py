...
PAYLOADS = {
    Domain.CYBERSECURITY: {"log_id": "LOG-E2E-001", "timestamp": "2026-08-14T00:00:00Z", "source_ip": "10.0.0.10", "event_type": "UNAUTHORIZED_SSH_ATTEMPT", "payload_summary": "Repeated failed SSH authentication attempts."},
    Domain.FINANCE: {"transaction_id": "TXN-E2E-001", "account_id": "ACC-001", "counterparty_id": "CP-001", "transaction_type": "WIRE_TRANSFER", "amount": 1000.0, "source_country": "US", "destination_country": "GB"},
    Domain.HEALTHTECH: {"encounter_id": "ENC-E2E-001", "patient_id": "PATIENT-HASH-001", "encounter_type": "AMBULATORY", "primary_symptom": "routine cough", "raw_notes": "No acute distress reported."},
    Domain.LOGISTICS: {"shipment_id": "SHP-E2E-001", "transport_mode": "OCEAN_CONTAINER", "carrier": "Example Carrier", "origin_country": "US", "destination_country": "GB", "hs_code": "100630", "declared_temp_range_c": [2.0, 8.0], "goods_value_usd": 10000.0, "telemetry": {"temperature_c": 5.0, "humidity_percent": 50.0, "shock_g_force": 0.1, "location_coords": "40.0,-73.0"}, "carrier_status_note": "On schedule."},
