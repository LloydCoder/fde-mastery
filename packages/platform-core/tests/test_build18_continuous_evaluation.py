...
def make_run(*, passed=99, total=100, security=True, status=EvaluationStatus.PASSED, version="2"):
    return EvaluationRun(
        ...
        metrics=(
            ...
            EvaluationMetric("cost", 1.0, 1.05, maximum=1.20),
            EvaluationMetric("latency", 1.0, 1.10, maximum=1.20),
        ),
        baseline_passed=99,
        baseline_total=100,
...
def test_blocks_security_failure():
